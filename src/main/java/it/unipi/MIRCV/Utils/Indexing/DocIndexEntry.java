/**
 * This class represents an entry in the document index, which contains information about a single document in the corpus.
 * Each entry includes the document ID, the path to the document file, and the document length in terms of the number of terms.
 */
