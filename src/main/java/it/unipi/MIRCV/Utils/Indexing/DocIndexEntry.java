...
public class DocIndexEntry {
    ...
    public long write2Disk(FileChannel fileChannel,long offset,int doc_id){
        try {
            ...
            return write2Disk(mappedByteBuffer, doc_id);
        }catch (IOException e){
    ...
    public long write2Disk(MappedByteBuffer mappedByteBuffer, int doc_id) {
        ...
        return mappedByteBuffer.position() + DOC_INDEX_ENTRY_SIZE;
    }    
